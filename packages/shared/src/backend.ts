...
export type StoredTelemetryDecisionRecord = TelemetryDecisionPayload & {
  ...
  trick_winner_seat: string | null;
  trick_winner_team: string | null;
  trick_points: number | null;
  actor_team_won_trick: boolean | null;
  hand_ns_score_delta: number | null;
  hand_ew_score_delta: number | null;
  actor_team_hand_score_delta: number | null;
  actor_team_won_hand: boolean | null;
  game_ns_final_score: number | null;
  game_ew_final_score: number | null;
  actor_team_won_game: boolean | null;
  final_hand_winner_team: string | null;
  final_game_winner_team: string | null;
  hand_result: JsonObject | null;
  game_result: JsonObject | null;
  outcome_reward: number | null;
  outcome_components: JsonObject | null;
