...
@"
Usage:
  scripts\install-backend.ps1 [options]
...
Write-Host "- Start/update backend: powershell -ExecutionPolicy Bypass -File scripts\start-backend.ps1"
Write-Host "- Check backend status: powershell -ExecutionPolicy Bypass -File scripts\status-backend.ps1"
Write-Host "- Stop backend: powershell -ExecutionPolicy Bypass -File scripts\stop-backend.ps1"
